...
/*
 *   constructor for L298P,which used 6 pin to drive
 *   Sets which wires should control the motor.
 */
Stepper::Stepper(int number_of_steps, int motor_pin_1, int motor_pin_2,
  int motor_pin_3, int motor_pin_4,
...
void Stepper::stepMotor(int thisStep)
{
  ...
  if (this->pin_count == 6) {
    switch (thisStep) {
      case 0:  // 01101
        digitalWrite(motor_pin_1, HIGH);//8   #1
        digitalWrite(motor_pin_2, LOW);//9    #2
        digitalWrite(motor_pin_3, HIGH);//10  #3
        digitalWrite(motor_pin_4, HIGH);//12  #5
        //digitalWrite(motor_pin_5, HIGH);
        //digitalWrite(motor_pin_5, HIGH);
        //digitalWrite(motor_pin_5, HIGH);
        break;
      case 1:  // 01001
        digitalWrite(motor_pin_1, LOW);//8
        digitalWrite(motor_pin_2, HIGH);//9
        digitalWrite(motor_pin_3, HIGH);//11
        digitalWrite(motor_pin_4, LOW);//13
        //digitalWrite(motor_pin_5, HIGH);
        break;
      case 2:  // 01011
        digitalWrite(motor_pin_1, HIGH);//8
        digitalWrite(motor_pin_2, LOW);//9
        digitalWrite(motor_pin_3, HIGH);//10
        digitalWrite(motor_pin_4, LOW);//12
        //digitalWrite(motor_pin_5, HIGH);
        break;
      case 3:  // 01010
        digitalWrite(motor_pin_1, LOW);//8
        digitalWrite(motor_pin_2, HIGH);//9
        digitalWrite(motor_pin_3, HIGH;//11
        digitalWrite(motor_pin_4, HIGH);//13
        //digitalWrite(motor_pin_5, LOW);
        break;
